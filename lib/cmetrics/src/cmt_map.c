                                      ...
                                      int write_op)
{
    ...
    metric = cmt_map_metric_create(hash, labels_count, labels_val);
    if (!metric) {
        return NULL;
    }
                                  ...
                                  char *label_value)
{
    ...
    metric = cmt_map_metric_create(hash, 0, NULL);
    ...
    for (index = 0 ; index < map->label_count ; index++) {
        if (index != label_index) {
            result = cmt_data_point_set_label_value(metric,
                                                    index,
                                                    "",
                                                    CMT_TRUE,
                                                    CMT_TRUE);
                                  ...
                                  label_transformer transformer)
{
    ...
    cfl_list_foreach(iterator, &map->metrics) {
        ...
        result = cmt_data_point_transform_label_value(metric,
                                                          label_index,
                                                          transformer);
                               ...
                               size_t label_index)
{
    ...
    cfl_list_foreach(iterator, &map->metrics) {
        ...
        result = cmt_data_point_remove_label_value(metric, label_index);
