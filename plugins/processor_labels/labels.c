                         ...
                         struct cfl_list *labels)
{
    ...
    cfl_list_foreach(iterator, labels) {
        ...
        if (result == FLB_TRUE) {
            ...
            if (result == FLB_FALSE) {
                result = cmt_insert_static_label(metrics_context,
                                                 pair->key,
                                                 pair->val);
                         ...
                         struct cfl_list *labels)
{
    ...
    cfl_list_foreach(iterator, labels) {
        ...
        if (result == FLB_TRUE) {
            result = cmt_update_upsert_dynamic_label(metrics_context,
                                                     pair->key,
                                                     pair->val);
            ...
            result = cmt_upsert_static_label(metrics_context,
                                             pair->key,
                                             pair->val);
                         ...
                         struct mk_list *labels)
{
    ...
    mk_list_foreach(iterator, labels) {
        ...
        if (result == FLB_TRUE) {
            result = cmt_update_remove_dynamic_label(metrics_context,
                                                     entry->str);
                       ...
                       struct mk_list *labels)
{
    ...
    mk_list_foreach(iterator, labels) {
        ...
        if (result == FLB_TRUE) {
            result = cmt_update_transform_dynamic_label(metrics_context,
                                                        entry->str,
                                                        hash_transformer);
